...
const faqs = [
  {
    id: '689013311',
    question: 'DJI Mavic 3 系列有几个版本？有什么区别？',
    answer:
      'DJI Mavic 3 系列目前有三个版本，分别是 Mavic 3 Classic、Mavic 3 和 Mavic 3 Pro。Mavic 3 Classic 为单摄云台，配备 4/3 CMOS 哈苏相机，续航约 46 分钟。Mavic 3 为双摄云台，在 Mavic 3 Classic 的基础上增加 162 mm 长焦相机，续航约 46 分钟。Mavic 3 Pro 为三摄云台，广角主摄是和 Mavic 3 Classic、Mavic 3 相同的 4/3 CMOS 哈苏相机，并且新增 1/1.3 英寸 CMOS 的 70 mm 中长焦相机，还有全新升级的 166 mm 长焦相机，画面表现更好，续航约 43 分钟。',
  },
  {
    id: '4134234231',
    question: 'DJI Mavic 3 系列是否支持 DJI 飞行眼镜和 DJI 穿越摇杆？',
    answer: '支持 DJI Goggles 2、DJI 飞行眼镜一体版、DJI 穿越摇杆 2。',
  },
  {
    id: '689424230',
    question: 'DJI Mavic 3 系列有几个版本？有什么区别？',
          ...
          <div className="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center mt-10 gap-x-6">
                <a
                  href="/"
                  className="rounded-md bg-primary px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-400"
                >
                  Get started
                </a>
                <a
            ...
            {features.map((feature) => (
              <div key={feature.name} className="relative pl-9">
                <dt className="inline font-semibold text-gray-900">
                  <feature.icon
                    className="absolute w-5 h-5 text-primary left-1 top-1"
                    aria-hidden="true"
                  />
                  {feature.name}
                </dt>{' '}
              ...
              <a
                ...
                className={classNames(
                  tier.featured
                    ...
                    : 'text-primary ring-1 ring-inset ring-indigo-200 hover:ring-indigo-300 focus-visible:outline-indigo-600',
            ...
            <Accordion type="single" collapsible className="w-full pt-6">
              {faqs.map(({id, question, answer}) => (
                <AccordionItem key={id} value={id}>
                  <AccordionTrigger className="hover:no-underline hover:text-parimary">
                    {question}
                  </AccordionTrigger>
