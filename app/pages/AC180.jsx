...
export function AC180() {
  return (
    <div className="bg-white">
      ...
      <div className="relative isolate">
        ...
        <div className="px-6 py-24 mx-auto max-w-7xl sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
          <div className="max-w-2xl mx-auto lg:mx-0 lg:flex-auto">
            <div className="flex">
              <div className="relative flex items-center px-4 py-1 text-sm leading-6 text-gray-600 rounded-full gap-x-4 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
            ...
            <div className="flex items-center mt-10 gap-x-6">
              <a
                href="/"
                className="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Get started
              </a>
              <a
      ...
      {/* Feature section */}
      <div className="container mt-32 sm:mt-56">
        <div className="relative px-6 py-20 overflow-hidden bg-gray-900 isolate sm:rounded-3xl sm:px-10 sm:py-24 lg:py-24 xl:px-24">
